...
function App() {
  return (
    <div className="App">
      ...
      <QuoteCard character="Lisa Simpson" quote="I am the best blah blah blah." image="https://i.f1g.fr/media/madame/400x/sites/default/files/img/2014/10/lisa-simpson.jpg"/> 
